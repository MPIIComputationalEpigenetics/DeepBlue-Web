...
*   All rights reserved.
*
*   File : select_annotations_server_processing.php
*
...
if ((!isset($_REQUEST)) || !isset($_REQUEST["annotations_names"])) {
	return;
}

$experiments_names = $_REQUEST["annotations_names"];
...
if (!$client->query("select_annotations", $experiments_names, "hg19", "", 0, PHP_INT_MAX, $user_key)) {
