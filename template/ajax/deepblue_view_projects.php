...
*   ================================================
*
*   File : deepblue_view_projects.php
*
*/
...
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="datatable-projects" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false">
				<!-- widget options:
	...
	var pagefunction = function() {
		...
		*/
		...
		otable.on('xhr.dt', function ( e, settings, json) {
			if ("error" in json) {
				swal("Error while loading the projects table.", json["error"], "error");
				json.aaData = [];
			}
		});
