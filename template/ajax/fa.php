		...
		<article class="col-sm-12">
			...
			<div class="jarviswidget jarviswidget-color-blue" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false">
				...
				<header>
					...
					<h2>Font Awesome 4.1 (updated) </h2>
				...
				<div>
					...
					<div class="widget-body" id="all-icons-demo">
							...
							<div class="alert alert-info">
								<i class="fa fa-exclamation"></i> Please note: As of the latest version of Font Awesome 4.1. All icons now require a base class of <code>
							...
							<h2>71 NEW icons in 4.1</h2>

							<div class="row">

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-automobile"></i> fa-automobile <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-bank"></i> fa-bank <span class="text-muted">(alias)</span></a>
								</div>
								...
								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-cube"></i> fa-cube</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-cubes"></i> fa-cubes</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-database"></i> fa-database</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-delicious"></i> fa-delicious</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-deviantart"></i> fa-deviantart</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-digg"></i> fa-digg</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-drupal"></i> fa-drupal</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-empire"></i> fa-empire</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-envelope-square"></i> fa-envelope-square</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-fax"></i> fa-fax</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-archive-o"></i> fa-file-archive-o</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-audio-o"></i> fa-file-audio-o</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-code-o"></i> fa-file-code-o</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-excel-o"></i> fa-file-excel-o</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-image-o"></i> fa-file-image-o</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-movie-o"></i> fa-file-movie-o <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-pdf-o"></i> fa-file-pdf-o</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-photo-o"></i> fa-file-photo-o <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-picture-o"></i> fa-file-picture-o <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-powerpoint-o"></i> fa-file-powerpoint-o</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-sound-o"></i> fa-file-sound-o <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-video-o"></i> fa-file-video-o</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-word-o"></i> fa-file-word-o</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-file-zip-o"></i> fa-file-zip-o <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-ge"></i> fa-ge <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-git"></i> fa-git</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-git-square"></i> fa-git-square</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-google"></i> fa-google</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-graduation-cap"></i> fa-graduation-cap</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-hacker-news"></i> fa-hacker-news</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-header"></i> fa-header</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-history"></i> fa-history</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-institution"></i> fa-institution <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-joomla"></i> fa-joomla</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-jsfiddle"></i> fa-jsfiddle</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-language"></i> fa-language</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-life-bouy"></i> fa-life-bouy <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-life-ring"></i> fa-life-ring</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-life-saver"></i> fa-life-saver <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-mortar-board"></i> fa-mortar-board <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-openid"></i> fa-openid</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-paper-plane"></i> fa-paper-plane</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-paper-plane-o"></i> fa-paper-plane-o</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-paragraph"></i> fa-paragraph</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-paw"></i> fa-paw</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-pied-piper"></i> fa-pied-piper</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-pied-piper-alt"></i> fa-pied-piper-alt</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-pied-piper-square"></i> fa-pied-piper-square <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-qq"></i> fa-qq</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-ra"></i> fa-ra <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-rebel"></i> fa-rebel</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-recycle"></i> fa-recycle</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-reddit"></i> fa-reddit</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-reddit-square"></i> fa-reddit-square</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-send"></i> fa-send <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-send-o"></i> fa-send-o <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-share-alt"></i> fa-share-alt</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-share-alt-square"></i> fa-share-alt-square</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-slack"></i> fa-slack</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-sliders"></i> fa-sliders</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-soundcloud"></i> fa-soundcloud</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-space-shuttle"></i> fa-space-shuttle</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-spoon"></i> fa-spoon</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-spotify"></i> fa-spotify</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-steam"></i> fa-steam</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-steam-square"></i> fa-steam-square</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-stumbleupon"></i> fa-stumbleupon</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-stumbleupon-circle"></i> fa-stumbleupon-circle</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-support"></i> fa-support <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-taxi"></i> fa-taxi</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-tencent-weibo"></i> fa-tencent-weibo</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-tree"></i> fa-tree</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-university"></i> fa-university</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-vine"></i> fa-vine</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-wechat"></i> fa-wechat <span class="text-muted">(alias)</span></a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-weixin"></i> fa-weixin</a>
								</div>

								<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									<i class="fa fa-wordpress"></i> fa-wordpress</a>
								</div>
