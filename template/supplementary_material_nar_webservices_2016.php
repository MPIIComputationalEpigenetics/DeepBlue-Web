    ...
    <div id="content" class="container">
        ...
        <dl class="dl-horizontal" id="freelance">
          ...
          <dt>
            ...
            <br />
            <br />
            <p>After, we extract the IDs from the listed experiments, obtain information about the experiment using the ID, and generate a list of experiments that the original file name ends with "bed.gz". <small>(lines 21-24)</small></p>
            <p>As we are interested only on one experiment file, we do a check if found only one experiment. <small>(lines 25-26)</small></p>
            <br />
            <br />
            <br />
            ...
            <br />
            <br />
            <p>Then, we list and extract the names of the <i>DNA Methylation</i> experiments that contains <i>liver</i> or <i>hepatocyte</i> biosource. <small>(lines 35-40)</small></p>
            <br />
            <br />
            <br />
            <br />
            ...
            <br />
            <br />
            <p>We iterate in each selected <i>DNA Methylation</i> experiment, selecting its regions. <small>(lines 47-52)</small></p>
            <br />
            <br />
            <br />
            <br />
            ...
            <br />
            <br />
            <p>We filter and remove the aggregated regions whom did not aggregated any region. <small>(lines 59-60)</small></p>
            <br />
            <br />
            ...
            <br />
            <br />
            <p> We create an directory to store the data download from DeepBlue. <small>(lines 72-73)</small>
            <br />
            <br />
            <br />
